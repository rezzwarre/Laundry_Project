        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{ route('admin.transaksi.edit', $transaksi->id) }}" class="btn btn-sm btn-warning text-dark me-2">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="text-dark">{{ $transaksi->user->name ?? 'N/A' }}</p>
                    </div>
                ...
                <table class="table table-sm table-borderless mb-4">
                    ...
                    <tr>
                        <td class="fw-bold">Satuan Barang</td>
                        <td>: {{ $transaksi->jasa->jenis_barang ?? 'N/A' }}</td>
                    </tr>
                    <tr>
                        <td class="fw-bold">Jumlah / Berat</td>
                        <td>: <strong>{{ $transaksi->jumlah_barang }}</strong></td>
                    </tr>
                    <tr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <span class="badge bg-{{ $transaksi->status_pembayaran == 'Lunas' ? 'success' : 'danger' }} p-2">
