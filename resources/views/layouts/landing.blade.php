...
<head>
    ...
    <link rel="apple-tounch-icon" sizes="180x180" href="{{ asset('logo/apple-touch-icon.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('libraries/glide/css/glide.core.min.css') }}">
	        ...
	        <div class="container py-1">
	            ...
	            <div class="offcanvas offcanvas-end border-0 rounded-start-0 rounded-start-sm-4" tabindex="-1" id="offcanvasNavbar2" aria-labelledby="offcanvasNavbar2Label">
	                <div class="offcanvas-header" style="padding: 2rem 2rem 1.5rem 2rem;">
	                    <h5 class="offcanvas-title m-0" id="offcanvasNavbar2Label">
	                        <a class="navbar-brand" href="javascript:;">
	                            <img src="{{ asset('logo/logo.png') }}" height="32" alt="logo">
	                        </a>
	                    </h5>
	                ...
	                <div class="offcanvas-body">
	                    <ul class="navbar-nav align-items-xl-center flex flex-grow-1 column-gap-4 row-gap-4 row-gap-xl-2">
	                        <li class="nav-item ms-xl-auto">
	                            <a href="{{ url('/') }}" class="px-3 text-body-emphasis bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold" aria-current="page">
	                                Home
	                            </a>
	                        </li>

	                        <li class="nav-item">
	                            <a href="{{ route('services') }}" class="px-3 text-body-emphasis bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold">
	                                Services
	                            </a>
	                        </li>

	                        <li class="nav-item">
	                            <a href="{{ route('about') }}" class="px-3 text-body-emphasis bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold">
	                                About
	                            </a>
	                        </li>
                            ...
                            <li class="nav-item d-xl-flex gap-2 ms-xl-3 mt-3 ms-xl-auto mt-xl-0">
                            @if (Route::has('login'))

                                @auth
                                    <a href="{{ url('/dashboard') }}" class="px-3 nav-link rounded-3 text-base leading-6 fw-semibold text-body-emphasis bg-body-secondary-hover text-center">
                                    Dashboard
                                    </a>
                                @else
                                    <a href="{{ route('login') }}" class="px-3 nav-link rounded-3 text-base leading-6 fw-semibold text-body-emphasis bg-body-secondary-hover text-center">
                                    Login
                                    </a>
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="px-3 nav-link rounded-3 text-base leading-6 fw-semibold text-white bg-primary text-center">
                                        Register
                                        </a>
                                    @endif
                                @endauth
...
<script src="{{ asset('libraries/glide/glide.min.js') }}"></script>
<script src="{{ asset('libraries/aos/aos.js') }}"></script>
<script src="{{ asset('js/scripts.js') }}"></script>
<script src="{{ asset('php/contact/script.js') }}"></script>
